import type { DirectionEnum, PlaneEnum, StateEnum } from './common/enums';
...
export type EventsType = {
  ...
  AbsoluteMode: EmptyEvent;
  MachinePlane: {
    machine_plane: PlaneEnum;
  };
  StartProgram: {
    xpos: number;
    ypos: number;
  ...
  StartOfJob: {
    ...
    C830_U_ZD?: number;
    C830_S_ZPV?: number;
    Cut_tolerance?: number;
    b832type?: number;
    ts_type?: number;
    ts_mtype?: number;
    bAirCoolant?: number;
    nAirCoolantDelay?: number;
    nAirCoolantDuration?: number;
    iCPM?: number;
    bSoft?: number;
    iWBCM?: number;
    sWCM_MSG?: string;
  ...
  Arc: {
    ...
    yhcenter_rel: number;
    zhcenter_rel: number;
    arc_plane_h: PlaneEnum;
    arc_direction_h: DirectionEnum;
  ...
  Drill: {
    ...
    cycle_clearance_z_precise?: number;
    cycle_upper_z_precise?: number;
    cycle_lower_z_precise?: number;
    drill_type: number;
    d_drill_type: string;
  ...
  LoopMatrixInfo: EmptyEvent;
  PlaneData: EmptyEvent;
  RotaryInfo: {
    rot_axis_type: string;
    radial_diameter: number;
    center_pos: number;
    rot_axis_coord: string;
  };
  FourthAxis: {
    direction_4x: DirectionEnum;
    angle: number;
    fourth_axis_first: number;
    fourth_axis_last: number;
    first_axis_angle: number;
    second_axis_angle: number;
    first_plane_angle: number;
    second_plane_angle: number;
    third_plane_angle: number;
    rotate_angle_x: number;
    rotate_angle_y: number;
    rotate_angle_z: number;
    euler_angle_z: number;
    euler_angle_x: number;
    euler_angle_dev_z: number;
    shift_x: number;
    shift_y: number;
    shift_z: number;
    shift_x_after_rot: number;
    ...
    shift_pos_y: number;
    shift_pos_z: number;
    shift_pos_m_x: number;
    shift_pos_m_y: number;
    shift_pos_m_z: number;
    shift_in_tilted_plane_x: number;
    shift_in_tilted_plane_y: number;
    shift_in_tilted_plane_z: number;
    normal_to_plane_x: number;
    normal_to_plane_y: number;
    normal_to_plane_z: number;
    x_vector_x: number;
    x_vector_y: number;
    x_vector_z: number;
    y_vector_x: number;
    y_vector_y: number;
    y_vector_z: number;
    machine_4x_direction: DirectionEnum;
  };
  RotateToPlane: EmptyEvent;
  ToolBreakage: EmptyEvent;
  EndOfFile: EmptyEvent;
  ChangeRefPoint: {
    xhome: number;
    yhome: number;
    zhome: number;
    absolute: boolean;
    ref_point_init: boolean;
  };
};
